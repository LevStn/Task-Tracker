...
public class ApiErrorMessage
{
    ...
    public const string CompletionDateLessStart = " Completion date  cannot be less start date";
    public const string StartDateCantBeMoreEndDate = "Start date cant be more completion date";
